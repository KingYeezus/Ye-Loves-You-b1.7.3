...
public class GuiClick extends GuiScreen{
	...
	int oldscroll = 0;
	int lastCategory = 0;
	net.minecraft.src.MEDMEX.Modules.Module.Category oldc = Module.Category.COMBAT;
	...
	public net.minecraft.src.MEDMEX.Modules.Module activeModule;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawRoundedRect(sr.getScaledWidth() / 2 - 150, 40, 300, 200, 0xff232323, "");
		fr.drawString("Ye", sr.getScaledWidth() / 2 - 10, 42, -1);
		...
		currentscroll += Mouse.getDWheel() / 120;
		...
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/clienticon.png"));
		this.drawModalRectWithCustomSizedTexture(sr.getScaledWidth() / 2 - 145, 40  + 14, 0, 0, 20, 20, 20, 20);
		
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/swordicon.png"));
		
		this.drawModalRectWithCustomSizedTexture(sr.getScaledWidth() / 2 - 150, 40 + 30 + 10, 0, 0, 30, 30, 30, 30);
		
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/movementicon.png"));
		this.drawModalRectWithCustomSizedTexture(sr.getScaledWidth() / 2 - 150, 40 + 30 * 2 + 10, 0, 0, 30, 30, 30, 30);
		
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/playericon.png"));
		this.drawModalRectWithCustomSizedTexture(sr.getScaledWidth() / 2 - 150, 40 + 30 * 3 + 10, 0, 0, 30, 30, 30, 30);
		
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/rendericon.png"));
		this.drawModalRectWithCustomSizedTexture(sr.getScaledWidth() / 2 - 150, 40 + 30 * 4 + 10, 0, 0, 30, 30, 30, 30);
		
		GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/worldicon.png"));
