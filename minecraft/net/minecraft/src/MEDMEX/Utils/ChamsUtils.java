...
public class ChamsUtils {
	 public static void renderOne()
	    ...
	    public static void setupFBO()
	    {
	        ...
	        // Width, Height
	        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, Minecraft.theMinecraft.displayWidth, Minecraft.theMinecraft.displayHeight);
