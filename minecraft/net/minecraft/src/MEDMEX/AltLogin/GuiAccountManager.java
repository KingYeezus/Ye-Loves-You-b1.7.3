package net.minecraft.src.MEDMEX.AltLogin;
...
public class GuiAccountManager extends GuiScreen {
	...
	public void initGui() {
		...
		this.loginField = new GuiTextField(this, this.fontRenderer, this.width / 2 - 150, 50, 300, 20, ""); //adds the login field(the text field)
		this.loginField.setMaxStringLength(32767);
		this.loginField.setFocused(true);
		
		this.controlList.add(this.loginButton = new GuiButton(1, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, "Login")); //adds the login button
       	this.controlList.add(this.cancelButton = new GuiButton(2, this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, "Cancel")); //adds the cancel button
	}
