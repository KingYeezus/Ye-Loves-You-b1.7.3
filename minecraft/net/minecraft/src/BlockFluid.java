...
public abstract class BlockFluid extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World var1, int var2, int var3, int var4) {
    	if(Jesus.instance.isEnabled() && Minecraft.theMinecraft.thePlayer != null && !Minecraft.theMinecraft.thePlayer.isInWater()) return AxisAlignedBB.getBoundingBox((double)var2 + this.minX, (double)var3 + this.minY, (double)var4 + this.minZ, (double)var2 + this.maxX, (double)var3 + this.maxY, (double)var4 + this.maxZ);
