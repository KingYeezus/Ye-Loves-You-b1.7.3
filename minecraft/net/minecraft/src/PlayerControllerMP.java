...
public class PlayerControllerMP extends PlayerController {
	...
	public void clickBlock(int var1, int var2, int var3, int var4) {
		if (!this.isHittingBlock || var1 != this.currentBlockX || var2 != this.currentBlockY
				|| var3 != this.currentblockZ) {
	...
	public void sendBlockRemoving(int var1, int var2, int var3, int var4) {
		if (this.isHittingBlock) {
			if (InstaMine.instance.onBreak(new Vec3D(var1, var2, var3), var4)) {
				return;
			}
			...
			if (this.blockHitDelay > 0) {
				...
				if (var1 == this.currentBlockX && var2 == this.currentBlockY && var3 == this.currentblockZ) {
					...
					if (this.field_9441_h % 4.0F == 0.0F && var6 != null) {
						this.mc.sndManager.playSound(var6.stepSound.stepSoundDir2(), (float) var1 + 0.5F,
								(float) var2 + 0.5F, (float) var3 + 0.5F, (var6.stepSound.getVolume() + 1.0F) / 8.0F,
	...
	public boolean sendPlaceBlock(EntityPlayer var1, World var2, ItemStack var3, int var4, int var5, int var6,
			int var7) {
		this.syncCurrentPlayItem();
		this.netClientHandler
				.addToSendQueue(new Packet15Place(var4, var5, var6, var7, var1.inventory.getCurrentItem()));
