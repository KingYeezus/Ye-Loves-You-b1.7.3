package net.minecraft.src.de.Hero.clickgui.elements;
...
import net.minecraft.src.de.Hero.clickgui.Panel;
import net.minecraft.src.de.Hero.clickgui.elements.menu.ElementCheckBox;
import net.minecraft.src.de.Hero.clickgui.elements.menu.ElementComboBox;
import net.minecraft.src.de.Hero.clickgui.elements.menu.ElementSlider;
import net.minecraft.src.de.Hero.clickgui.util.ColorUtil;
import net.minecraft.src.de.Hero.clickgui.util.FontUtil;
...
public class ModuleButton {
	 ...
	 * Konstrukor
	 */
	public ModuleButton(net.minecraft.src.MEDMEX.Modules.Module m, Panel pl) {
		mod = m;
		height = Minecraft.theMinecraft.fontRenderer.charHeight + 2;
		parent = pl;
