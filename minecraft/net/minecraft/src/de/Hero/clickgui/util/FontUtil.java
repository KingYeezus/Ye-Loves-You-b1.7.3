...
public class FontUtil {
	...
	public static int getFontHeight() {
		return fontRenderer.charHeight;
	}
	...
	public static void drawTotalCenteredString(String text, double x, double y, int color) {
		drawString(text, x - fontRenderer.getStringWidth(text) / 2, y - fontRenderer.charHeight / 2, color);
	}

	public static void drawTotalCenteredStringWithShadow(String text, double x, double y, int color) {
		drawStringWithShadow(text, x - fontRenderer.getStringWidth(text) / 2, y - fontRenderer.charHeight / 2F, color);
	}
}
